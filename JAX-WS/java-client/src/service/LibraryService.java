 ...
 * 
 */
@WebServiceClient(name = "LibraryService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/library?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LIBRARYSERVICE_QNAME = new QName("http://service/", "LibraryService");
    ...
    public Library getLibraryPort() {
        return super.getPort(new QName("http://service/", "LibraryPort"), Library.class);
    }
    ...
    public Library getLibraryPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "LibraryPort"), Library.class, features);
    }
